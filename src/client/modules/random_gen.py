...
class TestDataGenerator:
    ...
    MAIL_FIRST_PARTS = ["sharon", "richard", "justin", "ella", "jung", "hashimin", "bulsheesh", "scandalors", "melody", "acker", "jhony", "lexie", "khalifa", "stephen", "dorota", "georgeta", "krystiana", "gerbold", "iona", "lore", "surprize", "dog", "admin", "cat", "shermin"]
    MAIL_SECOND_PARTS = ["communication", "help", "gaming", "assistant", "trinity", "sponsor", "love_you", "nicelife", "sun", "mukbangs", "assistant", "support", "info", "work", "school", "help", "care", "random", "admin", "moderator", "adm", "mod"]
    MAIL_THIRD_PARTS = ["gmail", "outlook", "me", "yahoo", "github", "microsoft", "youtube", "guns", "coolmail", "google", "hotmail", "insta", "facebook", "msn", "gore", "braces"]
    MAIL_PART_CONNECTORS = ["-", "_", ".", ""]
    MAIL_FOURTH_PARTS = ["net", "de", "com", "you", "me", "online", "here"]

    PASSWORD_CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789,;.:-_#'+*<>´`=)(/&%$§!"

    NAMES = ["sharon", "richard", "justin", "ella", "hashimin", "melody", "jhony", "lexie", "khalifa", "stephen", "dorota", "georgeta", "krystiana", "gerbold", "iona", "shermin"]
