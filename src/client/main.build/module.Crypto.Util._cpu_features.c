...
static void createModuleCodeObjects(void) {
    ...
    codeobj_8f504fc396a759ce955d09db49daec3e = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[15], mod_consts[15], NULL, NULL, 0, 0, 0);
    codeobj_95a93859afc185b03b511bdaf5a54d03 = MAKE_CODE_OBJECT(module_filename_obj, 41, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[1], mod_consts[1], NULL, NULL, 0, 0, 0);
    codeobj_a0bd65bea9f2f9ed608813034be486e9 = MAKE_CODE_OBJECT(module_filename_obj, 45, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[2], mod_consts[2], NULL, NULL, 0, 0, 0);
}
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__1_have_aes_ni(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_95a93859afc185b03b511bdaf5a54d03 = MAKE_FUNCTION_FRAME(tstate, codeobj_95a93859afc185b03b511bdaf5a54d03, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_95a93859afc185b03b511bdaf5a54d03);
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__2_have_clmul(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a0bd65bea9f2f9ed608813034be486e9)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a0bd65bea9f2f9ed608813034be486e9 = MAKE_FUNCTION_FRAME(tstate, codeobj_a0bd65bea9f2f9ed608813034be486e9, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_a0bd65bea9f2f9ed608813034be486e9);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_8f504fc396a759ce955d09db49daec3e);
    ...
    }
    {
        ...
        tmp_assign_source_5 = CALL_FUNCTION_WITH_POSARGS2(tstate, tmp_called_value_1, mod_consts[13]);
