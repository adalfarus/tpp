...
function_impl_code functable_cffi$_imp_emulation[] = {
    impl_cffi$_imp_emulation$$$function__1_get_suffixes,
    impl_cffi$_imp_emulation$$$function__2_find_module,
    impl_cffi$_imp_emulation$$$function__3_load_dynamic,
    NULL
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_cffi$_imp_emulation;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_cffi$_imp_emulation) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_cffi$_imp_emulation[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 0x300
