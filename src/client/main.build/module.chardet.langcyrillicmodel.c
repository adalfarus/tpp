...
/* The "module_chardet$langcyrillicmodel" is a Python object pointer of module type.
 *
...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("chardet.langcyrillicmodel"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_chardet$langcyrillicmodel(PyThreadState *tstate) {
...
static PyCodeObject *codeobj_62e5fec2d040143f5ad09d97e4258a01;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[40]); CHECK_OBJECT(module_filename_obj);
    codeobj_62e5fec2d040143f5ad09d97e4258a01 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[41], mod_consts[41], NULL, NULL, 0, 0, 0);
}
...
PyObject *modulecode_chardet$langcyrillicmodel(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("chardet.langcyrillicmodel");

    // Store the module for future use.
    module_chardet$langcyrillicmodel = module;
    ...
    if (init_done == false) {
        ...
        NUITKA_PRINT_TRACE("chardet.langcyrillicmodel: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_chardet$langcyrillicmodel);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_62e5fec2d040143f5ad09d97e4258a01;
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict_chardet$langcyrillicmodel, (Nuitka_StringObject *)mod_consts[0], tmp_assign_source_1);
    }
    {
    ...
    frame_62e5fec2d040143f5ad09d97e4258a01 = MAKE_MODULE_FRAME(codeobj_62e5fec2d040143f5ad09d97e4258a01, module_chardet$langcyrillicmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_62e5fec2d040143f5ad09d97e4258a01);
    assert(Py_REFCNT(frame_62e5fec2d040143f5ad09d97e4258a01) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_62e5fec2d040143f5ad09d97e4258a01, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_62e5fec2d040143f5ad09d97e4258a01->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_62e5fec2d040143f5ad09d97e4258a01, exception_lineno);
    }



    assertFrameObject(frame_62e5fec2d040143f5ad09d97e4258a01);
    ...
    }
    {
        ...
        if (unlikely(tmp_dict_value_4 == NULL)) {
            tmp_dict_value_4 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[13]);
        }
    ...
    }
    {
        ...
        if (unlikely(tmp_dict_value_5 == NULL)) {
            tmp_dict_value_5 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[17]);
        }
    ...
    }
    {
        ...
        if (unlikely(tmp_dict_value_6 == NULL)) {
            tmp_dict_value_6 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[19]);
        }
    ...
    PGO_onModuleExit("chardet.langcyrillicmodel", false);

    Py_INCREF(module_chardet$langcyrillicmodel);
