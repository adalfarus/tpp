...
static PyObject *impl_numpy$lib$shape_base$$$function__7_apply_along_axis(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    try_end_1:;
    {
...

        {
            ...
            tmp_args_element_value_7 = impl___main__$$$function__4_complex_call_helper_pos_star_list_star_dict(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_11 = impl___main__$$$function__4_complex_call_helper_pos_star_list_star_dict(tstate, dir_call_args);
        }
...
static PyObject *impl_numpy$lib$shape_base$$$function__9_apply_over_axes(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_9 = impl___main__$$$function__6_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_assign_source_9 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
