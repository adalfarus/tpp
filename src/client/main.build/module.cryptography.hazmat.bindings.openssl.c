...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("cryptography.hazmat.bindings.openssl"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_cryptography$hazmat$bindings$openssl(PyThreadState *tstate) {
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_e44250fe22049c206962a547c58e8709 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[21], mod_consts[21], NULL, NULL, 0, 0, 0);
}
...
PyObject *modulecode_cryptography$hazmat$bindings$openssl(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        NUITKA_PRINT_TRACE("cryptography.hazmat.bindings.openssl: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_cryptography$hazmat$bindings$openssl);
...
// Mark the execution in the "__spec__" value.
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_e44250fe22049c206962a547c58e8709);
    ...
    }
    {
        ...
        tmp_assattr_target_1 = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$bindings$openssl, (Nuitka_StringObject *)mod_consts[15]);
    ...
    }
    {
        ...
        tmp_assattr_target_2 = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$bindings$openssl, (Nuitka_StringObject *)mod_consts[15]);
    ...
    }
    {
        ...
        tmp_assattr_target_3 = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$bindings$openssl, (Nuitka_StringObject *)mod_consts[15]);
    ...
    frame_no_exception_1:;
    {
        ...
        UPDATE_STRING_DICT0(moduledict_cryptography$hazmat$bindings$openssl, (Nuitka_StringObject *)mod_consts[19], tmp_assign_source_4);
    }
