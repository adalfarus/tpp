...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("cryptography.x509.oid"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_cryptography$x509$oid(PyThreadState *tstate) {
...
static PyCodeObject *codeobj_b8e88bfe9535cacd2e2508168179e93b;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[23]); CHECK_OBJECT(module_filename_obj);
    codeobj_b8e88bfe9535cacd2e2508168179e93b = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_FUTURE_ANNOTATIONS, mod_consts[24], mod_consts[24], NULL, NULL, 0, 0, 0);
}
...
PyObject *modulecode_cryptography$x509$oid(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        NUITKA_PRINT_TRACE("cryptography.x509.oid: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_cryptography$x509$oid);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_b8e88bfe9535cacd2e2508168179e93b;
    ...
    frame_b8e88bfe9535cacd2e2508168179e93b = MAKE_MODULE_FRAME(codeobj_b8e88bfe9535cacd2e2508168179e93b, module_cryptography$x509$oid);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_b8e88bfe9535cacd2e2508168179e93b);
    assert(Py_REFCNT(frame_b8e88bfe9535cacd2e2508168179e93b) == 2);
    ...
    }
    {
        ...
        frame_b8e88bfe9535cacd2e2508168179e93b->m_frame.f_lineno = 7;
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_cryptography$x509$oid, (Nuitka_StringObject *)mod_consts[20], tmp_assign_source_16);
    }
    goto try_end_1;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_b8e88bfe9535cacd2e2508168179e93b, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_b8e88bfe9535cacd2e2508168179e93b->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_b8e88bfe9535cacd2e2508168179e93b, exception_lineno);
    }



    assertFrameObject(frame_b8e88bfe9535cacd2e2508168179e93b);
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        tmp_assign_source_17 = MAKE_LIST11(mod_consts[21]);
        UPDATE_STRING_DICT1(moduledict_cryptography$x509$oid, (Nuitka_StringObject *)mod_consts[22], tmp_assign_source_17);
    }
